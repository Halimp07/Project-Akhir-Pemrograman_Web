...
<body id="page-top">
    ...
    <footer class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto text-center">
                    ...
                    <!-- Pastikan untuk mengubah alamat email di KEDUA teks jangkar dan target tautan di bawah ini!-->
                    <a class="d-block"
        ...
        <br>
        <div class="container">
            <div class="small text-center text-muted">Welcome - <?php echo $_SESSION['setting_name'] ?> | <a
                    href="https://github.com/Halimp07" target="_blank">Source Code</a></div>
        </div>
    </footer>
