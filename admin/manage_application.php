                ...
                <div class="col-md-6">
                    ...
                    <select class="custom-select browser-default select2" name="position_id">
                        ...
                        <option value="<?php echo $k ?>"
                            <?php echo isset($position_id) && $position_id == $k ? "selected" : '' ?>><?php echo $v ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="input-group col-md-10 mb-3">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label"
                            for="resume"><?php echo isset($fname) ? $fname:'Choose file'  ?></label>
                    </div>
                </div>
            </div>
            <?php if(isset($id)): ?>
            <div class="row form-group">
                <div class="col-md-6">
                    ...
                    <select class="custom-select browser-default select2" name="status">
                        ...
                        <option value="<?php echo $k ?>"
                            <?php echo isset($process_id) && $process_id == $k ? "selected" : '' ?>><?php echo $v ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
