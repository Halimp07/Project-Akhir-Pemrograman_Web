                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary edit_scat" type="button"
                                            data-id="<?php echo $row['id'] ?>"
                                            data-status_label="<?php echo $row['status_label'] ?>">Edit</button>
                                        <button class="btn btn-sm btn-danger delete_scat" type="button"
